...
export const WorkflowEventTypeSchema = z.enum(['RUN_STARTED','NODE_STARTED','NODE_PROGRESS','AGENT_MESSAGE','NODE_COMPLETED','REVIEW_RESULT','RUN_COMPLETED','RUN_FAILED']);
